            ...
            <div class="container-fluid">
                <section id="main-content">
                    <section class="wrapper">
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="page-header"><i class="fa fa-table"></i> เพิ่มประเภทสินค้า</h3>
                                <!-- <ol class="breadcrumb">
                                ...
                                <div class="breadcrumb">
                                    <section class="panel">
                                        <div class="panel-body">
                                            <form role="form" action="{{route('create_type')}}" method="POST">
                                                {{csrf_field()}}
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">เนื้อหา</label>
                                                    <input class="form-control" name="name" id="name" placeholder="ชื่อประเภทสินค้า">
